# Django settings for walkyear project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'walkyear',                      # Or path to database file if using sqlite3.
        'USER': 'walkyear_user',                      # Not used with sqlite3.
        'PASSWORD': 'wK3HAl8e6hMrTdSzjsOg2IE61rHM50',                  # Not used with sqlite3.
...
SECRET_KEY = 'SM)QA"<*/"b*$O3LM397=oQ8Igp1\3%2JnlCcn3*J<gA!NuaO6'
...
ROOT_URLCONF = 'walkyear.urls'

WSGI_APPLICATION = 'walkyear.wsgi.application'
